...
const NewChatBoat = () => {
  ...
  return (
    <div className="app-container">
            ...
            <div className="history-section">
                ...
                <div className="history-item">What are the eligibility for criteria for a loan?</div>
                <div className="history-item">What is the interest rate for personal loans?</div>
  ...
  <div className="user-profile">
    <img className="avatar" src="https://ui-avatars.com/api/?name=Noah+Johnson&background=4CAF50&color=fff" alt="User Avatar" />
    ...
    <span className="dropdown-icon">▼</span>
        ...
        <div className="quick-queries">
          {queries.map((query, index) => (
            <button key={index} className="query-button">{query}</button>
          ))}
        </div>
        ...
        <div className="chat-input">
                <input type="text" placeholder="Ask me anything..." maxLength={3000} />
